...
export class GeoInfoComponent implements OnInit {
  ...
  public savePlace(place){
    ...
    this.newPlace.icon = place.photos[0].getUrl({'maxWidth': 170, 'maxHeight': 150})
    ...
    this.alertNotification.emit({
      alertShow : true,
      alertMessage : "The places has to be SAVED, check on your respective profiles to see your profile updates"
    })
  }
