  ...
  public deletePlace(id){
    ...
    .subscribe(res => {
      ...
      .subscribe(data => {
        this.allPlaces = data;
        this.alertShow = true
        this.alertMessage = "The place has been DELETED and the profile is saved"
        setTimeout(function(){
          this.alertShow = false
        }, 3000);
      });
  ...
  public sendNote(id,note) {
    ...
    .subscribe(res => {
      ...
      .subscribe(data => {
        this.allRoutes = data;
        this.alertShow = true
        this.alertMessage = "Your notes has been saved, check your saved notes on your ROUTES tab"
        setTimeout(function(){
          this.alertShow = false
        }, 3000);
      });
